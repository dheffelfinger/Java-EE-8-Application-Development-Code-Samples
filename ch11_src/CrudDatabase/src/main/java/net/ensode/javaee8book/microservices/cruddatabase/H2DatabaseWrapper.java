package net.ensode.javaee8book.microservices.cruddatabase;
...
public class H2DatabaseWrapper {
    ...
    private void startH2Database() {
        ...
        try {
            ...
            String dbFileName = "microprofilecrud.mv.db";

            String tmpDir = System.getProperty("java.io.tmpdir");

            String dbFileNamePath = String.format("%s%s%s", tmpDir, System.getProperty("file.separator"), dbFileName);

            String jdbcUrl = String.format("jdbc:h2:tcp://localhost/%s/microprofilecrud", tmpDir);
